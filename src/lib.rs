...
#[derive(Debug)]
pub struct EmberCLIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EmberCLIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EmberCLI processing");
    
    let mut processor = EmberCLIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EmberCLIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EmberCLIProcessor::new(false);
